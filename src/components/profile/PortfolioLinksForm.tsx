...
import { Save, Link2, Linkedin, Instagram, Globe, Video } from 'lucide-react';
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label className="flex items-center gap-1.5"><Globe className="h-4 w-4" /> Outro Link</Label>
            <Input value={form.portfolio_url} onChange={e => set('portfolio_url', e.target.value)} placeholder="https://qualquer-link.com" maxLength={200} />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input value={form.github_url} onChange={e => set('github_url', e.target.value)} placeholder="https://instagram.com/seu-perfil" maxLength={200} />
          </div>
          <div className="space-y-2">
